...
/**
 * Confidential EHR-launched SMART app.
 *
 * The EHR visits:
 *   GET /launch?iss=<FHIR_SERVER_URL>&launch=<LAUNCH_TOKEN>
 *
 * This handler discovers authorization/token URLs via smartAuthMetadata(),
 * then redirects the user's browser to the EHR's authorization server.
 */
