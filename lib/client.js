...
class Client {
   ...
   *
   * This allows you to get the raw response object.
   *
   * @static
   *
   * @example
   ...
   * @return {Object} HTTP fetch response object
   */
   ...
   *
   * This allows you to get the raw object, including request headers.
   *
   * @static
   *
   * @example
   ...
   *   id: 12345,
   * }).then((data) => {
   *   const request = Client.requestFor(data);
   *   console.log(request.headers);
   * });
   *
   * @param {Object} requestResponse to one of the FHIR Kit Client requests
   * @return {Object} HTTP fetch request object
   */
  static requestFor(requestResponse) {
    return HttpClient.requestFor(requestResponse);
  }
