...
const { createQueryString, validateParameters } = require('./utils');
...
class Client {
  ...
  read({ resourceType, id, headers, options = {} } = {}) {
    validateParameters({ resourceType, id, requireId: true });
  ...
  vread({ resourceType, id, version, headers, options = {} } = {}) {
    validateParameters({ resourceType, id, version, requireId: true, requireVersion: true });
  ...
  create({ resourceType, body, headers, options = {} } = {}) {
    validateParameters({ resourceType });
  ...
  delete({ resourceType, id, headers, options = {} } = {}) {
    validateParameters({ resourceType, id, requiredId: true });
  ...
  compartmentSearch({ resourceType, compartment, searchParams, headers, options = {} } = {}) {
    ...
    validateParameters({ resourceType });
    validateParameters({ resourceType: compartmentType, id: compartmentId, requireId: true });
