...
class Client {
   ...
   *
   * This allows you to get the raw object, including headers.
   *
   * @static
   *
   * @example
   ...
   *   id: 12345,
   * }).then((data) => { console.log(Client.requestFor(data)); });
   *
   * // Using async
   * let response = await fhirClient.read({ resourceType: 'Patient', id: 12345 });
   * console.log(Client.requestFor(response)); // <http request object>
   *
