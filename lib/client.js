...
class Client {
  ...
  async smartAuthMetadata({ headers, options = {} } = {}) {
    const fetchOptions = { ...deprecateHeaders(options, headers) };
    if (!(fetchOptions.headers)) { fetchOptions.headers = {}; }
    fetchOptions.headers.accept = 'application/fhir+json,application/json';
    ...
    return new Promise((resolve, reject) => {
      ...
      const wellKnownSmartUrl = `${normalizedBaseUrl}.well-known/smart-configuration`;
      ...
      const wellKnownOidcUrl = `${normalizedBaseUrl}.well-known/openid-configuration`;
      this.httpClient.request('GET',
        wellKnownOidcUrl,
