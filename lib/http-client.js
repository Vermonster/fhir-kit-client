...
const defaultContentType = 'application/fhir+json';
...
module.exports = class HttpClient {
   ...
   * @param {Function} [config.requestSigner] Optionally pass in a function to sign the request.
  ...
  async put(url, body, options = {}) {
    ...
    const contentType = lcKeys(this.customHeaders)['content-type'] || defaultContentType;
    const headers = {
