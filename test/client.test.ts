...
describe('Client', () => {
  ...
  it('throws an error if baseUrl is blank', () => {
    ...
    expect(() => {
      fhirClient.baseUrl = '';
    }).toThrow('baseUrl cannot be blank');
  });
  ...
  describe('#capabilityStatement', () => {
    ...
    it('returns a FHIR resource from the FHIR server', async () => {
      server.use(
        http.get(`${BASE_URL}/metadata`, () =>
          HttpResponse.json(readFixture('no-smart-oauth-uri-capability-statement.json')),
        ),
      );
  ...
  describe('#resolve', () => {
    it('builds a request with custom headers', async () => {
      ...
      let capturedHeaders: Headers | null = null;
      server.use(
        http.get(`${BASE_URL}/${reference}`, ({ request }) => {
          capturedHeaders = request.headers;
  ...
  describe('#bearerToken=', () => {
    it('sets the Authorization header to a Bearer token', async () => {
      ...
      server.use(
        http.get(`${BASE_URL}/Patient/test-access-token`, ({ request }) => {
  ...
  describe('API verbs', () => {
    describe('#request', () => {
      ...
      it('GET request with custom headers', async () => {
        ...
        await fhirClient.request('Patient/123', {
          options: { headers: { accept: 'application/json', 'x-header-a': 'foo' } },
        });
    ...
    describe('#read', () => {
      it('builds requests with custom headers', async () => {
        server.use(
          http.get(`${BASE_URL}/Patient/test-access-token`, () => HttpResponse.json(readFixture('patient.json'))),
        );
      ...
      it('throws errors for a missing resource', async () => {
        server.use(
          http.get(`${BASE_URL}/Patient/abcdef`, () =>
            HttpResponse.json(readFixture('patient-not-found.json'), { status: 404 }),
          ),
        );
    ...
    describe('#vread', () => {
      it('returns a matching resource', async () => {
        server.use(
          http.get(`${BASE_URL}/Patient/eb3271e1-ae1b-4644-9332-41e32c829486/_history/1`, () =>
            HttpResponse.json(readFixture('patient.json')),
          ),
        );

        const response = await fhirClient.vread({
          resourceType: 'Patient',
      ...
      it('builds a request with custom headers', async () => {
        let capturedAbc: string | null = null;
        server.use(
          http.get(`${BASE_URL}/Patient/eb3271e1-ae1b-4644-9332-41e32c829486/_history/1`, ({ request }) => {
            capturedAbc = request.headers.get('abc');
            return HttpResponse.json(readFixture('patient.json'));
          }),
        );
      ...
      it('throws errors for an absent resource', async () => {
        server.use(
          http.get(`${BASE_URL}/Patient/abcdef/_history/1`, () =>
            HttpResponse.json(readFixture('patient-not-found.json'), { status: 404 }),
          ),
        );
      ...
      it('throws errors for an absent version of an existing resource', async () => {
        server.use(
          http.get(`${BASE_URL}/Patient/eb3271e1-ae1b-4644-9332-41e32c829486/_history/2`, () =>
            HttpResponse.json(readFixture('patient-version-not-found.json'), { status: 404 }),
          ),
        );

        await expect(
          fhirClient.vread({ resourceType: 'Patient', id: 'eb3271e1-ae1b-4644-9332-41e32c829486', version: '2' }),
    ...
    describe('#search', () => {
      ...
      it('routes to compartmentSearch when given a compartment param', async () => {
        server.use(
          http.get(`${BASE_URL}/Patient/123/Condition`, () =>
            HttpResponse.json(readFixture('compartment-search-results.json')),
          ),
        );
    ...
    describe('#resourceSearch', () => {
      it('builds a request with custom headers', async () => {
        let capturedAbc: string | null = null;
        server.use(
          http.get(`${BASE_URL}/Patient`, ({ request }) => {
            capturedAbc = request.headers.get('abc');
            return HttpResponse.json(readFixture('search-results.json'));
          }),
        );

        const response = await fhirClient.resourceSearch({
          resourceType: 'Patient',
      ...
      it('performs a POST search', async () => {
        ...
        server.use(
          http.post(`${BASE_URL}/Patient/_search`, ({ request }) => {
    ...
    describe('#systemSearch', () => {
      it('builds a request with custom headers', async () => {
        ...
        const response = await fhirClient.systemSearch({
      ...
      it('performs a POST search', async () => {
        let capturedContentType: string | null = null;
        server.use(
          http.post(`${BASE_URL}/_search`, ({ request }) => {
            capturedContentType = request.headers.get('content-type');
            return HttpResponse.json(readFixture('system-search-results.json'));
          }),
        );
      ...
      it('supports repeated query params', async () => {
        ...
        const response = await fhirClient.systemSearch({
          searchParams: { name: 'abcdef', _include: ['Observation', 'MedicationRequest'] },
        });
        expect(response.resourceType).toBe('Bundle');
    ...
    describe('#compartmentSearch', () => {
      ...
      it('builds a request with custom headers', async () => {
        let capturedAbc: string | null = null;
        server.use(
          http.get(`${BASE_URL}/Patient/385800201/Condition`, ({ request }) => {
            capturedAbc = request.headers.get('abc');
      ...
      it('returns a matching search results bundle with query params', async () => {
        server.use(
          http.get(`${BASE_URL}/Patient/385800201/Condition`, () =>
            HttpResponse.json(readFixture('compartment-search-with-query-results.json')),
          ),
        );
        const response = await fhirClient.compartmentSearch({
          compartment: { resourceType: 'Patient', id: '385800201' },
      ...
      it('performs a POST search', async () => {
        server.use(
          http.post(`${BASE_URL}/Patient/385800201/Condition/_search`, () =>
            HttpResponse.json(readFixture('compartment-search-with-query-results.json')),
          ),
        );
        const response = await fhirClient.compartmentSearch({
    ...
    describe('pagination', () => {
      ...
      describe('#prevPage', () => {
        ...
        it('detects and responds to "prev" relations', async () => {
          server.use(http.get(`${BASE_URL}/`, () => HttpResponse.json(readFixture('search-results-page-1.json'))));
          const bundle = readFixture('search-results-page-2.json') as {
    ...
    describe('#create', () => {
      ...
      it('builds a request with custom headers', async () => {
        let capturedAbc: string | null = null;
        server.use(
          http.post(`${BASE_URL}/Patient`, ({ request }) => {
            capturedAbc = request.headers.get('abc');
      ...
      it('returns a successful operation outcome', async () => {
        server.use(
          http.post(`${BASE_URL}/Patient`, () =>
            HttpResponse.json(readFixture('patient-created.json'), { status: 201 }),
          ),
        );
        const response = await fhirClient.create({ resourceType: newPatient.resourceType, body: newPatient });
        expect(response.resourceType).toBe('OperationOutcome');
        expect((response as Record<string, Array<{ diagnostics: string }>>).issue[0].diagnostics).toContain(
      ...
      it('throws an error if the resource type format is invalid', () => {
        ...
        expect(() => fhirClient.create({ resourceType: newRecord.resourceType, body: newRecord })).toThrow(
    ...
    describe('#delete', () => {
      it('builds a request with custom headers', async () => {
        let capturedAbc: string | null = null;
        server.use(
          http.delete(`${BASE_URL}/Patient/152746`, ({ request }) => {
            capturedAbc = request.headers.get('abc');
      ...
      it('returns a successful operation outcome', async () => {
        server.use(
          http.delete(`${BASE_URL}/Patient/152746`, () => HttpResponse.json(readFixture('patient-deleted.json'))),
        );
      ...
      it('throws an error for a missing resource', async () => {
        server.use(
          http.delete(`${BASE_URL}/Patient/abcdef`, () =>
            HttpResponse.json(readFixture('patient-not-found.json'), { status: 404 }),
          ),
        );
    ...
    describe('#update', () => {
      ...
      it('builds a request with custom headers', async () => {
        let capturedAbc: string | null = null;
        server.use(
          http.put(`${BASE_URL}/Patient/152747`, ({ request }) => {
            capturedAbc = request.headers.get('abc');
      ...
      it('returns a successful operation outcome', async () => {
        server.use(
          http.put(`${BASE_URL}/Patient/152747`, () => HttpResponse.json(readFixture('patient-updated.json'))),
        );
      ...
      it('throws an error for a missing resource', async () => {
        server.use(
          http.put(`${BASE_URL}/Patient/abcdef`, () =>
            HttpResponse.json(readFixture('patient-not-found.json'), { status: 404 }),
          ),
        );
    ...
    describe('#patch', () => {
      it('builds a request with custom headers', async () => {
        ...
        let capturedAbc: string | null = null;
        server.use(
          http.patch(`${BASE_URL}/Patient/152747`, ({ request }) => {
            capturedAbc = request.headers.get('abc');
      ...
      it('throws an error when given an invalid patch', async () => {
        ...
        server.use(
          http.patch(`${BASE_URL}/Patient/152747`, () =>
            HttpResponse.json(readFixture('patient-not-patched.json'), { status: 500 }),
          ),
        );

        await expect(
          fhirClient.patch({ resourceType: 'Patient', id: '152747', jsonPatch: invalidPatch }),
        ).rejects.toMatchObject({
    ...
    describe('#transaction', () => {
      ...
      it('throws an error if any operations are unsuccessful', async () => {
        server.use(
          http.post(`${BASE_URL}/`, () =>
            HttpResponse.json(readFixture('transaction-error-response.json'), { status: 404 }),
          ),
        );
    ...
    describe('#history', () => {
      it('calls resourceHistory when given the "resourceType" and "id" params', async () => {
        server.use(
          http.get(`${BASE_URL}/Patient/152747/_history`, () =>
            HttpResponse.json(readFixture('resource-history.json')),
          ),
        );
    ...
    describe('#resourceHistory', () => {
      it('builds a request with custom headers', async () => {
        let capturedAbc: string | null = null;
        server.use(
          http.get(`${BASE_URL}/Patient/152747/_history`, ({ request }) => {
            capturedAbc = request.headers.get('abc');
            return HttpResponse.json(readFixture('resource-history.json'));
          }),
        );

        const response = await fhirClient.resourceHistory({
          resourceType: 'Patient',
          id: '152747',
          options: { headers: { abc: 'XYZ' } },
        });
    ...
    describe('#typeHistory', () => {
      it('builds a request with custom headers', async () => {
        let capturedAbc: string | null = null;
        server.use(
          http.get(`${BASE_URL}/Patient/_history`, ({ request }) => {
            capturedAbc = request.headers.get('abc');
            return HttpResponse.json(readFixture('type-history.json'));
          }),
        );

        const response = await fhirClient.typeHistory({
          resourceType: 'Patient',
          options: { headers: { abc: 'XYZ' } },
        });
        expectHistoryBundle(response as Record<string, unknown>, 15);
    ...
    describe('#systemHistory', () => {
      it('builds a request with custom headers', async () => {
        let capturedAbc: string | null = null;
        server.use(
          http.get(`${BASE_URL}/_history`, ({ request }) => {
            capturedAbc = request.headers.get('abc');
  ...
  describe('#noUrlInjection', () => {
    it('rejects url injection through resourceType', () => {
      expect(() => fhirClient.read({ resourceType: 'https://bad-server/Patient', id: '123' })).toThrow(
        /Invalid resourceType/,
      );
    });

    it('rejects url injection through resourceType and id', () => {
      expect(() => fhirClient.read({ resourceType: 'https:/', id: 'bad-server/Patient/123' })).toThrow(
        /Invalid resourceType/,
      );
    });
  });
